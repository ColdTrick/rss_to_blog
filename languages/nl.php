...
return array (
  'item:object:rss_to_blog' => 'RSS to Blog configuratie',
  'collection:object:rss_to_blog' => 'RSS to Blog configuraties',
  'collection:object:blog:all:internal' => 'Interne blogs',
  'collection:object:blog:all:external' => 'Externe blogs',
  'collection:object:blog:group:internal' => 'Interne groepsblogs',
  'collection:object:blog:group:external' => 'Externe groepsblogs',
  'inspect:object:rss_to_blog' => 'Inspect RSS to Blog: %s',
  'rss_to_blog:inspect' => 'Inspecteer RSS-feed',
  'rss_to_blog:inspect:unable_to_parse' => 'Onmogelijk om de RSS-feed output te tonen',
  'rss_to_blog:menu:filter:internal' => 'Intern',
  'rss_to_blog:menu:filter:external' => 'Extern',
  'rss_to_blog:settings:split_blogs' => 'Voeg tabs toe aan blog lijsten om intern/externe blogs los te tonen',
  'rss_to_blog:settings:split_blogs:help' => 'Als dit aan staat zullen er 2 tabs worden toegevoegd aan de lijstpagina\'s met aparte lijsten voor interne en externe blogs.',
